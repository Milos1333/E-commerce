  ...
  const items = [
    {
      ...
      title: "FREE UPDATES",
      description:
        "Stay ahead with our regular free updates, ensuring your headphones always have the latest features and enhancements for an optimal listening experience.",
    },
    {
      img: easyToUseImg,
      title: "EASY TO USE",
